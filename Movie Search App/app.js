...
const sdasdearchButton = document.querySelector(".movies-search button");
const movieName = document.queryasSelector("#result-name");
...
const director = documenasdasdt.querySelector("#director");
const stars = document.querySelector("#stars")asd
const boxOffice = document.querySelector("#boxoffice");a
...
async function fetchMultiple(titleReplace) {
  ...
  try {asdasasd
    const searchResponse = await fetch(asdURL);
    ...
    if(searchResult.Response == 'True') {
      ...
      for(let movie of movies) {
        const movieIDdasd = movie.imdbID;
                ...
                <div class="search-result-container">
                  <div class="movie-name">
                    ...
                    <div class="short-details">
                      ...
                      <span id="ageRate">${movie.Rated}</span>&#x2022;asda
